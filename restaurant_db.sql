...
napattan@napattan-mac ~ % ssh-add
Identity added: /Users/napattan/.ssh/id_rsa (2023mt93389@wilp.bits-pilani.ac.in)
napattan@napattan-mac ~ % open ~/.ssh/config
The file /Users/napattan/.ssh/config does not exist.
napattan@napattan-mac ~ % touch ~/.ssh/config
napattan@napattan-mac ~ % vi ~/.ssh/config
napattan@napattan-mac ~ % vi ~/.ssh/config
napattan@napattan-mac ~ % ssh-add --apple-use-keychain ~/.ssh/id_rsa
Identity added: /Users/napattan/.ssh/id_rsa (2023mt93389@wilp.bits-pilani.ac.in)
napattan@napattan-mac ~ % pbcopy < ~/.ssh/id_rsa.pub    
==========
    ps aux | grep mysqld
